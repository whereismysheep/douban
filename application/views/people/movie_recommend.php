	...
	<div class="public_main">
		...
		<div class="mb_detail" style="height:auto;">
			<div class="mb_detail_title">
				<?php echo $this->account_model->get_account_name($page_uid); ?>收藏的电影，你没看过 . . . ( <span style="color:#009148;" class="no_unl">&nbsp;<?php echo $movie_his_own_count; ?>部&nbsp;</span> )
			</div>
			<div class="mb_image" style="height:auto;">
				<?php if ($movie_his_own_count > 0): ?>
					...
					<!-- 5 star -->
					<?php if ($five_count > 0): ?>
					<?php foreach($movie_his_own_five as $value): ?>
					...
					<!-- 4 star -->
					<?php if ($four_count > 0): ?>
					<?php foreach($movie_his_own_four as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://movie.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_movie_image($value); ?>" />
					...
					<?php foreach($movie_his_own_three as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://movie.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_movie_image($value); ?>" />
					...
					<!-- 2 star -->
					<?php if ($two_count > 0): ?>
					<?php foreach($movie_his_own_two as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://movie.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_movie_image($value); ?>" />
					...
					<!-- 1 star -->
					<?php if ($one_count > 0): ?>
					<?php foreach($movie_his_own_one as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://movie.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_movie_image($value); ?>" />
