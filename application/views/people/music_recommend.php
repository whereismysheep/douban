	...
	<div class="public_main">
		...
		<div class="mb_detail" style="height:auto;">
			<div class="mb_detail_title">
				<?php echo $this->account_model->get_account_name($page_uid); ?>收藏的音乐，你没听过 . . . ( <span style="color:#009148;" class="no_unl">&nbsp;<?php echo $music_his_own_count; ?>张&nbsp;</span> )
			</div>
			<div class="mb_image" style="height:auto;">
				<?php if ($music_his_own_count > 0): ?>
					...
					<!-- 5 star -->
					<?php if ($five_count > 0): ?>
					<?php foreach($music_his_own_five as $value): ?>
					...
					<!-- 4 star -->
					<?php if ($four_count > 0): ?>
					<?php foreach($music_his_own_four as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://music.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_music_image($value); ?>" />
					...
					<?php foreach($music_his_own_three as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://music.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_music_image($value); ?>" />
					...
					<!-- 2 star -->
					<?php if ($two_count > 0): ?>
					<?php foreach($music_his_own_two as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://music.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_music_image($value); ?>" />
					...
					<!-- 1 star -->
					<?php if ($one_count > 0): ?>
					<?php foreach($music_his_own_one as $value): ?>
						<div class="fl img_display">
							<div class="image_mb">
								<a href="http://music.douban.com/subject/<?php echo $value; ?>/" target="_blank" class="no_unl">
									<img src="<?php echo $this->douban_model->get_music_image($value); ?>" />
