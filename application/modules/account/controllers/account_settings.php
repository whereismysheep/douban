	...
	function index()
	{
		...
		if ($this->form_validation->run()) 
		{
			...
			else
			{
				...
				$this->account_model->update_email($data['account']->uid, $this->input->post('settings_email') ? $this->input->post('settings_email') : NULL);
				...
				$this->account_details_model->update($data['account']->uid, $attributes);
